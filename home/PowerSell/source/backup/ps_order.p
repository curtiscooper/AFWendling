...
/*                    substr(tt-Confirm-Item.Msg,1,30).                    */
            assign
                cLine = string(ORDER_ITEM.LINE,"9999") no-error.
            assign 
                cUnit = ORDER_ITEM.UNIT no-error.
            assign 
                cQtyOrd = string(ORDER_ITEM.QTY_ORD,"-9999") no-error.
            assign 
                cQtyShip = string(ORDER_ITEM.QTY_SHIP,"-9999") no-error.
            assign
                cSub     = string(ORDER_ITEM.SUB&) no-error.
            assign 
